      ...
      <div class="form-center">
        <div class="row-flex">
          <div class="form-small-div col-flex">
            <label class="Form-Label"
              >Mã nhãn dán<span style="color: red">*</span></label
            >
            <input
              type="text"
              class="form-input"
              ...
              maxlength="20"
            />
            <label v-show="checkNull('category_code')" class="text-error"
          ...
          <div class="form-big-div col-flex">
            <label class="Form-Label"
              >Tên nhãn dán <span style="color: red">*</span></label
            >
            <input
              type="text"
              class="form-input"
            ...
            />
            <label v-show="checkNull('category_name')" class="text-error"
              >Cần phải nhập thông tin</label
            >
          </div>
          <div class="form-small-div col-flex">
        ...
        <div class="row-flex">
          <div class="col-flex">
            ...
            <input type="text" class="form-input" v-model="item.description" />
          </div>
        </div>
      </div>

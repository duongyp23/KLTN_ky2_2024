<template>
    <MsTool
        @deleteSelectList="openPopupDelete()"
    ></MsTool>
    <table class="table" 
        tabindex="0"
    ...
    >
        <thead>
            <tr>
                ...
                <th  class="col-type" >Loại tài sản</th>
                ...
                <th  class="col-info" >Trạng thái</th>
        ...
        <tbody ref="tbody">
                ...
                <MsRow
                    ...
                    @createCopy ="createCopy(item)"
                    @deleteItem="openPopupDelete(item)"
                ...
                <div v-if="datalist.length == 0 && isLoader == false" style="position:relative; text-align: center; align-items: center;padding: 10px;">
                    Không có tài sản nào cả 
                </div>     
        </tbody>
        <tfoot>
            <tr style="background-color: #f5f5f5;">
                <td></td>
                <th  class="col-num"  >{{replaceNumber(totalQuantity())}}</th>
...
export default {
    ...
    components: { MsRow,VPagination, MsTool},
    methods: {
        /**
